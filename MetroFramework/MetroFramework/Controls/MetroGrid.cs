...
namespace MetroFramework.Controls
{
    public partial class MetroGrid : DataGridView, IMetroControl
    {
        ...
        private MetroGridSize _RowFontSize ;
        [Category("Metro Appearance")]
        public MetroGridSize RowFontSize
        {
            get { return _RowFontSize; }
            set { _RowFontSize = value; StyleGrid(); }
        }

        private MetroGridSize _ColFontSize;
        [Category("Metro Appearance")]
        public MetroGridSize ColFontSize
        {
            get { return _ColFontSize; }
            set { _ColFontSize = value; StyleGrid(); }
        }

        private MetroGridWeight _fontWeight;
        [Category("Metro Appearance")]
        public MetroGridWeight FontWeight
        {
            get { return _fontWeight; }
            set { _fontWeight = value; StyleGrid(); }
        }
        ...
        private void StyleGrid()
        {
            ...
            this.ColumnHeadersDefaultCellStyle.Font = MetroFonts.Grid(_ColFontSize,_fontWeight);
            this.RowsDefaultCellStyle.Font = MetroFonts.Grid(_RowFontSize, _fontWeight);

            //switch (_ColFontSize)
            //{
            //    case MetroGridSize.Small:
            //        //this.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 11f, FontStyle.Regular, GraphicsUnit.Pixel);

            //        this.ColumnHeadersDefaultCellStyle.Font = MetroFonts.Grid(_ColFontSize);
            //        break;
            //    case MetroGridSize.Medium:
            //        this.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 13f, FontStyle.Regular, GraphicsUnit.Pixel);
            //        break;
            //    case MetroGridSize.Tall:
            //        this.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 15, FontStyle.Regular, GraphicsUnit.Pixel);
            //        break;
            //}
            ...
            //{
            //    case MetroGridSize.Small:
            //        this.RowsDefaultCellStyle.Font = new Font("Segoe UI", 11f, FontStyle.Regular, GraphicsUnit.Pixel);
            //        break;
            //    case MetroGridSize.Medium:
            //        this.RowsDefaultCellStyle.Font = new Font("Segoe UI", 13f, FontStyle.Regular, GraphicsUnit.Pixel);
            //        break;
            //    case MetroGridSize.Tall:
            //        this.RowsDefaultCellStyle.Font = new Font("Segoe UI", 15f, FontStyle.Regular, GraphicsUnit.Pixel);
            //        break;
            //}
